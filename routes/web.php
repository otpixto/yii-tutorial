...
Route::group( [ 'middleware' => [ 'web', 'srm' ] ], function ()
{
    ...
    Route::group( [ 'middleware' => 'auth' ], function ()
    {
        ...
        Route::prefix( 'catalog' )->group( function ()
        {
            ...
            Route::get( 'buildings/managements/mass-edit', 'Catalog\BuildingsController@massManagementsEdit' )->name( 'buildings.managements.massManagementsEdit' );
            ...
            Route::get( 'buildings/mass-update', 'Catalog\BuildingsController@massUpdate' )->name( 'buildings.massUpdate' );
            Route::get( 'buildings/search/form', 'Catalog\BuildingsController@searchForm' )->name( 'buildings.search.form' );
            ...
            Route::get( 'types/export', 'Catalog\TypesController@export' )->name( 'types.export' );

            Route::get( 'types/export-directory', 'Catalog\TypesController@exportDirectory' )->name( 'types.export.directory' );

            Route::post( 'types/upload', 'Catalog\TypesController@upload' )->name( 'types.upload' );
        ...
        Route::prefix( 'admin' )->group( function ()
        {
            ...
            Route::post( 'users/{user_id}/types', 'Admin\UsersController@typesSelect' )->name( 'users.types' );
            ...
            Route::delete( 'users/{user_id}/managements/empty', 'Admin\UsersController@managementsEmpty' )->name( 'users.managements.empty' );
