    ...
    @if ( \Auth::user()->can( 'catalog.buildings.edit' ) )
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                {!! Form::model( null, [ 'method' => 'post', 'route' => 'types.managements.massManagementsAdd', 'class' => 'submit-loading' ] ) !!}
                <input type="hidden" name="types" value="{{ $managementTypesListString }}">
