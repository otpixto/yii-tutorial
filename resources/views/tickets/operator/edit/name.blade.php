...
<div class="form-group">
	...
	<div class="col-xs-8">
		{!! Form::text( 'lastname', $ticket->lastname, [ 'class' => 'form-control', 'required' ] ) !!}
	</div>
</div>
<div class="form-group">
	{!! Form::label( 'firstname', 'Имя', [ 'class' => 'control-label col-xs-4' ] ) !!}
	<div class="col-xs-8">
		{!! Form::text( 'firstname', $ticket->firstname, [ 'class' => 'form-control', 'required' ] ) !!}
	</div>
</div>
<div class="form-group">
	{!! Form::label( 'middlename', 'Отчество', [ 'class' => 'control-label col-xs-4' ] ) !!}
	<div class="col-xs-8">
		{!! Form::text( 'middlename', $ticket->middlename, [ 'class' => 'form-control' ] ) !!}
	</div>
</div>
{!! Form::close() !!}