...
@section( 'content' )
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                {!! Form::model( null, [ 'method' => 'post', 'route' => 'users.managements.massManagementsAdd', 'class' => 'submit-loading' ] ) !!}
                <input type="hidden" name="managements" value="{{ $usersManagementsListString }}">
