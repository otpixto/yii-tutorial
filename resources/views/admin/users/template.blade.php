        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="{{ route( 'users.regions', $user->id ) }}" class="list-group-item @if ( \Request::route()->getName() == 'users.regions' ) active @endif">
                ...
                @if ( ( \Auth::user()->admin || \Auth::user()->can( 'admin.loginas' ) ) && \Auth::user()->id != $user->id && ( $user->can( 'supervisor.all_regions' ) || $user->regions()->count() ) )
