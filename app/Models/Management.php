...
class Management extends BaseModel
{
    ...
    const MANAGEMENTS_APPLICANTS_DATA = [
        'applicants_lastname' => 'lastname',
        'applicants_name' => 'firstname',
        'applicants_middlename' => 'middlename',
        'applicants_phone' => 'phone',
        'applicants_extra_phone' => 'phone2',
        'applicants_email' => 'email',
        'applicants_building_id' => 'actual_building_id',
        'applicants_actual_flat' => 'actual_flat',
    ];
    ...
    protected $nullable = [
        ...
        'applicants_lastname',
        'applicants_name',
        'applicants_middlename',
        'applicants_phone',
        'applicants_extra_phone',
        'applicants_email',
        'applicants_building_id',
        'applicants_actual_flat',
    ];
